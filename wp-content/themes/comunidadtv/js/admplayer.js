		...
		//Marca cuando se hace play en un video, se debe reemplazar nombre_del_video por el que se est� invocando
		function myOnPlay() {
		...
		//Marca cuando se hace pause en un video, se debe reemplazar nombre_del_video por el que se est� invocando
		function myOnPause() {
		titulo = admplayer.getSWF().getCurrentContent().title;
		titulo1 = titulo.replace(/[ ]/gi,"_");
		titulo2 = titulo1.replace(/[']/gi,"");
		...
		//Inicializa el video, debo reemplazar nombre_del_video por el que se est� invocando
